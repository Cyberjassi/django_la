"""
Django settings for y94middleware project.
...
SECRET_KEY = 'django-insecure-=eer#7+j4@70w$c$*z1+24koi6u%^)f6ize&ynp89qb1*s7mf0'
...
ROOT_URLCONF = 'y94middleware.urls'
...
WSGI_APPLICATION = 'y94middleware.wsgi.application'
